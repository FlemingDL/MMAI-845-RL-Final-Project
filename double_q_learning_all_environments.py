'''
Double Q-Learn code from: PyTorch 1.0 Reinforcement Learning (Packt Publishing)
...
save_to_dirs = ['./double_q_learn_outputs_5x5/', './double_q_learn_outputs_10x10/',
                './double_q_learn_outputs_15x15/', './double_q_learn_outputs_20x20/']
